...
def train_ensemble(model, dataset, fn_loss, lr, size_batch, device):
    ...
    score_calibration_eval = evaluation.evaluate_model(model, dataset_eval, [calibration.get_score_calibration_mm], device)[0]

    return losses_eval_best, score_calibration_eval
